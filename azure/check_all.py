...
def initialize():
    global model
    model_path = '/home/asaaditya8/PycharmProjects/Codefundopp/weights/xception_all_rvm_2.pth'
...
if __name__ == '__main__':
    initialize()
    PATH = '/home/asaaditya8/PycharmProjects/Codefundopp'
    # for f in os.listdir(PATH):
    f = 'data/test/Volcanoes/383.jpg'
